...
const refreshToken_1 = __importDefault(require("../models/token/refreshToken"));
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield refreshToken_1.default.create({ token: refreshToken, userId: user.id });
...
exports.auth = { registerUser, loginUser, generateRefreshToken };
